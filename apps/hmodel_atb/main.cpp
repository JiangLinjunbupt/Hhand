...
int main(int argc, char* argv[]) {
	...
	std::string sequence_path = "C:/Users/78513/Downloads/";
	std::string data_path = "O:/githubProjects/hmodel-cpp-public/data/";
	std::string sequence_name = "teaser";

	Q_INIT_RESOURCE(shaders);   //通过qrc文件来导入各种资源。
	QApplication app(argc, argv);

	Camera camera(Intel_, 60);
