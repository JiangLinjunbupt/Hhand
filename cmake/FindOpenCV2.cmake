...
find_path(OpenCV2_ROOT_INC_DIR NAMES opencv2/opencv.hpp
    PATHS
        #--- WINDOWS
        O:/opencv2.4.13.5/opencv/build/include               # Windows
...
list(APPEND OPENCV2_LIBRARY_SEARCH_PATHS "O:/opencv2.4.13.5/opencv/build/x64/vc14/lib")
...
find_library(OpenCV2_CORE_LIBRARY_REL       NAMES opencv_core2413                         PATHS ${OPENCV2_LIBRARY_SEARCH_PATHS})
find_library(OpenCV2_IMGPROC_LIBRARY_REL    NAMES opencv_imgproc2413             PATHS ${OPENCV2_LIBRARY_SEARCH_PATHS})
find_library(OpenCV2_CONTRIB_LIBRARY_REL    NAMES opencv_contrib2413             PATHS ${OPENCV2_LIBRARY_SEARCH_PATHS})
find_library(OpenCV2_HIGHGUI_LIBRARY_REL    NAMES opencv_highgui2413             PATHS ${OPENCV2_LIBRARY_SEARCH_PATHS})
...
if(WIN32)
    find_library(OpenCV2_CORE_LIBRARY_DEB       NAMES  opencv_core2413d                     PATHS ${OPENCV2_LIBRARY_SEARCH_PATHS})
    find_library(OpenCV2_IMGPROC_LIBRARY_DEB    NAMES opencv_imgproc2413d         PATHS ${OPENCV2_LIBRARY_SEARCH_PATHS})
    find_library(OpenCV2_CONTRIB_LIBRARY_DEB    NAMES  opencv_contrib2413d         PATHS ${OPENCV2_LIBRARY_SEARCH_PATHS})
    find_library(OpenCV2_HIGHGUI_LIBRARY_DEB    NAMES opencv_highgui2413d         PATHS ${OPENCV2_LIBRARY_SEARCH_PATHS})
...
set(OpenCV2_LIBRARIES "")    #set the OPENCV2_LIBARIES  empty, then add above LIBRIES
if(WIN32)
